...
import br.com.neillon.network.extensions.OkHttpExtensions.addQueryParameterInterceptor
...
object RetrofitFactory {
    ...
    inline fun <reified S> createService(): S {
        val client = OkHttpClient.Builder().run {
            ...
            addLogInterceptor()
            addQueryParameterInterceptor(Constants.Network.AUTH_QUERY_KEY, BuildConfig.WEATHER_API_KEY)
            build()
        }
